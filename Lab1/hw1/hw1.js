...
const Product = class Product {
    ...
    constructor(product){
        ...
        this.price = parseFloat(productArray[1]);
    ...
    static printProducts = (products) => {
        products.forEach(product => console.log(`Product: ${product.name}, Cost: $${product.price.toFixed(2)}, Availability: ${product.availability == "In Stock"? "Yes" : "No"}`))
    }
